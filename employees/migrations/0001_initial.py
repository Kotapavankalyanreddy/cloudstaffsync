    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('staff', 'Staff'), ('management', 'Management')], default='staff', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('staff_id', models.IntegerField(default=0, validators=[django.core.validators.MaxValueValidator(9999999999)])),
                ('Dob', models.DateField(blank=True, null=True)),
                ('mobile_no', models.CharField(blank=True, max_length=10, validators=[employees.models.validate_mobile_no])),
